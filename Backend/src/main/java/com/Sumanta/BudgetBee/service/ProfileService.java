...
import com.Sumanta.BudgetBee.util.JWTUtil;
...
public class ProfileService {
    ...
    public ProfileDTO registerProfile(ProfileDTO profileDTO){
        ...
        String subject = "Activate your BudgetBee account.";
        String body = "Click on the following link to activate your BudgetBee account: " + activationLink;
